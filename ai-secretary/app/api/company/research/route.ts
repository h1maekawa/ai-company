...
export async function POST(req:NextRequest){
  ...
  try{const result=await runInteractiveResearch({question:body.question});return NextResponse.json({routing:result.routing,artifact:result.artifact,reused:result.reused,refreshed:result.refreshed});}
