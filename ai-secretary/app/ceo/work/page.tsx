...
const areas = [
  ["Creator", "/ceo/departments/creator", "企画・公開・収益"], ["Fund", "/ceo/departments/fund", "分析候補・Decision・Ledger"],
  ["Operations", "/ceo/departments/operations", "自動化・介入・失敗"], ["Knowledge", "/ceo/departments/knowledge", "Captureと昇格候補"],
  ["Planning", "/ceo/departments/planning", "Task・Mission・Blocked"], ["Engineering", "/ceo/departments/engineering", "Issue・Worker・PR"],
];
