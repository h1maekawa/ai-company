...
const ALLOWED: Record<string, FullMissionStatus[]> = {
  ...
  EXECUTING: ["REVIEWING", "FAILED", "CANCELLED", "BLOCKED"],
  REVIEWING: ["WAITING_APPROVAL", "COMPLETED", "FAILED", "REPLAN_REQUIRED"],
  WAITING_APPROVAL: ["COMPLETED", "REPLAN_REQUIRED", "FAILED", "CANCELLED"],
