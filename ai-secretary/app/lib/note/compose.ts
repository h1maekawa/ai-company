...
- 丁寧な共感確認ではなく、自分の本音を短く置く独り言の文体にする
- 「〜と感じているのではないでしょうか」「皆さんも〜ではありませんか」「〜と思いませんか」は使わない
- 読者を「皆さん」「あなた」と呼びかけない。反応を取るための質問や、整いすぎた締めを付けない
- 「マジ明日だるいな」「会社行きたくないな」のような友達に漏らす自然な温度感を参考にする。ただし例文をコピーせず、本人が入力した言葉を優先する
