...
# 1) エンジン・ポリシー・市場データ計算
npx tsc app/lib/fund/policy.ts app/lib/fund/engine.ts app/lib/fund/rakutenCsv.ts app/lib/fund/marketData/calc.ts app/lib/fund/analyst.ts app/lib/fund/learning/types.ts app/lib/fund/learning/engine.ts \
